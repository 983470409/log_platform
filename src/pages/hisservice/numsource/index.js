...
class Widget extends React.Component {
  ...
  componentDidMount() {
    ...
    // console.log(this.state.nowServiceTypeInfo);
    // 通过这个业务类型查询其子类型
    // dispatch({
    //   type: 'bindCard/getSubServiceType',
    //   payload: {
    //     serviceType: thisService.serviceType,
    //     subServiceType: thisService.subServiceType,
    //   },
  ...
  serviceSubInfo = (serviceTypeDate) =>{
    ...
    dispatch({
      type: 'numsource/getSubServiceType',
      payload: {
      ...
      <div className={styles['p-version']}>
        <Form className={styles.query}>
          <Row>
            ...
            <Col span={10}>
              <Form.Item label="科室/医生名称" {...layout}>
                <Input
