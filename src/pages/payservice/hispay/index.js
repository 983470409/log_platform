...
import {message, Row, Col, Form, Select, Input, Button, Icon, Modal, List, Avatar, Skeleton, Tree} from 'antd';
...
class Widget extends React.Component {
  ...
  componentDidMount() {
    console.log(filterHtmlElement("a"), '555');
      ...
      <div className={styles['p-version']}>
        <Form className={styles.query}>
          <Row>
            ...
            <Col span={12}>
              <Form.Item label="姓名/身份证/手机号" {...layout}>
                <Input
            ...
            <Col span={10}>
              <Form.Item label="海鹚流水号/订单号" {...layout}>
                <Input
